...
- **Submission Checklist**:
  1. **jsonl Files**:
     ...
     - File Structure Example: [HD-Track1-1&2.jsonl](https://github.com/ASLP-lab/Hum-Dial/blob/main/Emotional_Intelligence/submit/HD-Track1-T1%262.jsonl), [HD-Track1-3.jsonl](https://github.com/ASLP-lab/Hum-Dial/blob/main/Emotional_Intelligence/submit/HD-Track1-T3.jsonl)
  ...
  3. **System Description Document**:
     - Each team must submit a system description document in PDF format. The document must be **at least 2 pages in length**, including references.
